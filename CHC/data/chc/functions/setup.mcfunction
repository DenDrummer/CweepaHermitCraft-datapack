...
scoreboard objectives add BoneBlockCrafted minecraft.crafted:minecraft.bone_block
...
scoreboard objectives add BerriesMined minecraft.mined:minecraft.sweet_berry_bush
